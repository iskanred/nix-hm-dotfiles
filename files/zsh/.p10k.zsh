# Generated by Powerlevel10k configuration wizard on 2026-02-09 at 12:06 +08.
...
# no frame, light-ornaments, sparse, many icons, concise, instant_prompt=verbose.
...
() {
  ...
  # Always show context (user@hostname) even without SSH or sudo.
